...
- Analyze liquidity position using Current Ratio, Quick Ratio, and Cash Ratio  
- Evaluate profitability using Net Profit Margin, ROA, and ROE  
...
- Conducted **Year-over-Year (YoY) performance comparison**  
- Assessed **working capital components** including:
  - Current Assets  
  - Current Liabilities  
  - Inventory  
  - Accounts Receivable  
- Categorized analysis into **4 financial performance dimensions**
